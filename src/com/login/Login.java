...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fondoConLineas = new javax.swing.JLabel();
        msmBienvenida = new javax.swing.JLabel();
        txtIniciarSesion = new javax.swing.JLabel();
        txtUsuario = new javax.swing.JLabel();
        userTxt = new javax.swing.JTextField();
        jSeparator1 = new javax.swing.JSeparator();
        txtConstraseña = new javax.swing.JLabel();
        ...
        txtIniciarSesion.setForeground(new java.awt.Color(38, 41, 43));
        txtIniciarSesion.setText("INICIAR SESIÓN");
        bg.add(txtIniciarSesion, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 130, -1, -1));

        txtUsuario.setFont(new java.awt.Font("Roboto Light", 1, 14)); // NOI18N
        txtUsuario.setForeground(new java.awt.Color(38, 41, 43));
        txtUsuario.setText("USUARIO");
        bg.add(txtUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 200, 70, -1));
        ...
        bg.add(userTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 230, 410, 30));

        jSeparator1.setForeground(new java.awt.Color(0, 0, 0));
        bg.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 260, 410, 20));

        txtConstraseña.setFont(new java.awt.Font("Roboto Light", 1, 14)); // NOI18N
        txtConstraseña.setForeground(new java.awt.Color(38, 41, 43));
        txtConstraseña.setText("CONTRASEÑA");
        ...
        bg.add(passTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 320, 410, 30));

        jSeparator2.setForeground(new java.awt.Color(0, 0, 0));
        bg.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 350, 410, 20));

        loginBtn.setBackground(new java.awt.Color(95, 122, 219));

        loginBtnTxt.setBackground(new java.awt.Color(95, 122, 219));
        ...
        bg.add(loginBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 410, 130, 40));
        ...
        exitTxt.setForeground(new java.awt.Color(38, 41, 43));
        exitTxt.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        exitTxt.setText("X");
        exitTxt.setToolTipText("");
        exitTxt.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        exitTxt.setPreferredSize(new java.awt.Dimension(8, 15));
        ...
        exitBtnLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, exitBtnLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(exitTxt, javax.swing.GroupLayout.DEFAULT_SIZE, 11, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void loginBtnTxtMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBtnTxtMouseExited
        loginBtn.setBackground(new Color(95, 122, 219));
    ...
    private void exitTxtMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_exitTxtMousePressed
        //Aquí ya no se hizo nada, se utilizó mejor el MouseClicked
    ...
    private javax.swing.JLabel fondoConLineas;
    ...
    private javax.swing.JLabel msmBienvenida;
    private javax.swing.JPasswordField passTxt;
    private javax.swing.JLabel txtConstraseña;
